...
export type CreatureEntityType = EntityData & {entityType: ENTITY_TYPE.CREATURE}

export class CreatureEntity implements CreatureEntityType {
   entityName: string;
   entityId: number;
  ...
  constructor(entityParameters: EntityData) {
    ...
    this.entityType = ENTITY_TYPE.CREATURE;
